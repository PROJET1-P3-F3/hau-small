 ...
 *
 * @export
 * @interface StudentTranscriptClaim
 */
export interface StudentTranscriptClaim {
  /**
   *
   * @type {string}
   * @memberof StudentTranscriptClaim
   */
  id?: string
  /**
   *
   ...
   * @memberof StudentTranscriptClaim
   */
  status?: StudentTranscriptClaimStatusEnum
  /**
   *
   * @type {string}
   * @memberof StudentTranscriptClaim
...
export const StudentTranscriptClaimStatusEnum = {
  Open: 'OPEN',
  Close: 'CLOSE'
} as const

export type StudentTranscriptClaimStatusEnum = (typeof StudentTranscriptClaimStatusEnum)[keyof typeof StudentTranscriptClaimStatusEnum]

/**
 *
 * @export
 * @interface StudentTranscriptVersion
 */
export interface StudentTranscriptVersion {
  /**
   *
   * @type {string}
   * @memberof StudentTranscriptVersion
   */
  id?: string
  /**
   *
...
export interface Transcript {
   ...
   * @memberof Transcript
   */
  semester?: TranscriptSemesterEnum
  /**
   *
   * @type {number}
   * @memberof Transcript
...
export const TranscriptSemesterEnum = {
  S1: 'S1',
  S2: 'S2',
  S3: 'S3',
  S4: 'S4',
...
export type TranscriptSemesterEnum = (typeof TranscriptSemesterEnum)[keyof typeof TranscriptSemesterEnum]
...
export const TranscriptApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    /**
     *
     * @summary Create new transcript or update existing transcript
     * @param {string} studentId
     * @param {Array<Transcript>} transcript Groups to update
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    crudStudentTranscripts: async (studentId: string, transcript: Array<Transcript>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'studentId' is not null or undefined
      assertParamExists('crudStudentTranscripts', 'studentId', studentId)
      // verify required parameter 'transcript' is not null or undefined
      assertParamExists('crudStudentTranscripts', 'transcript', transcript)
      const localVarPath = `/students/{student_id}/transcripts`.replace(`{${'student_id'}}`, encodeURIComponent(String(studentId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
      ...
      let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {}
      localVarRequestOptions.headers = { ...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers }
      localVarRequestOptions.data = serializeDataIfNeeded(transcript, localVarRequestOptions, configuration)
    ...
    /**
     *
     * @summary Get a claim of transcript version.
     * @param {string} studentId
     ...
     * @throws {RequiredError}
     */
    getStudentClaimOfTranscriptVersion: async (
      studentId: string,
      transcriptId: string,
      versionId: string,
      claimId: string,
      ...
      // verify required parameter 'studentId' is not null or undefined
      assertParamExists('getStudentClaimOfTranscriptVersion', 'studentId', studentId)
      // verify required parameter 'transcriptId' is not null or undefined
      assertParamExists('getStudentClaimOfTranscriptVersion', 'transcriptId', transcriptId)
      // verify required parameter 'versionId' is not null or undefined
      assertParamExists('getStudentClaimOfTranscriptVersion', 'versionId', versionId)
      // verify required parameter 'claimId' is not null or undefined
      assertParamExists('getStudentClaimOfTranscriptVersion', 'claimId', claimId)
      const localVarPath = `/students/{student_id}/transcripts/{transcript_id}/versions/{version_id}/claims/{claim_id}`
        .replace(`{${'student_id'}}`, encodeURIComponent(String(studentId)))
    ...
    /**
     *
     * @summary Get a student transcript by identifier
     * @param {string} studentId
     * @param {string} transcriptId
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getStudentTranscriptById: async (studentId: string, transcriptId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'studentId' is not null or undefined
      assertParamExists('getStudentTranscriptById', 'studentId', studentId)
      // verify required parameter 'transcriptId' is not null or undefined
      assertParamExists('getStudentTranscriptById', 'transcriptId', transcriptId)
      const localVarPath = `/students/{student_id}/transcripts/{transcript_id}`
        .replace(`{${'student_id'}}`, encodeURIComponent(String(studentId)))
        .replace(`{${'transcript_id'}}`, encodeURIComponent(String(transcriptId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
    ...
    /**
     *
     * @summary Get details of specific version of a student transcript.
     * @param {string} studentId
     * @param {string} transcriptId
     * @param {string} versionId
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getStudentTranscriptByVersion: async (
      studentId: string,
      transcriptId: string,
      versionId: string,
      options: AxiosRequestConfig = {}
      ...
      // verify required parameter 'studentId' is not null or undefined
      assertParamExists('getStudentTranscriptByVersion', 'studentId', studentId)
      // verify required parameter 'transcriptId' is not null or undefined
      assertParamExists('getStudentTranscriptByVersion', 'transcriptId', transcriptId)
      // verify required parameter 'versionId' is not null or undefined
      assertParamExists('getStudentTranscriptByVersion', 'versionId', versionId)
      const localVarPath = `/students/{student_id}/transcripts/{transcript_id}/versions/{version_id}`
        .replace(`{${'student_id'}}`, encodeURIComponent(String(studentId)))
        .replace(`{${'transcript_id'}}`, encodeURIComponent(String(transcriptId)))
        .replace(`{${'version_id'}}`, encodeURIComponent(String(versionId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    /**
     *
     * @summary Get all claims for a specific version of a student transcript.
     * @param {string} studentId
     * @param {string} transcriptId
     * @param {string} versionId
     * @param {number} [page]
     ...
     * @throws {RequiredError}
     */
    getStudentTranscriptClaims: async (
      studentId: string,
      transcriptId: string,
      versionId: string,
      page?: number,
      ...
      // verify required parameter 'studentId' is not null or undefined
      assertParamExists('getStudentTranscriptClaims', 'studentId', studentId)
      // verify required parameter 'transcriptId' is not null or undefined
      assertParamExists('getStudentTranscriptClaims', 'transcriptId', transcriptId)
      // verify required parameter 'versionId' is not null or undefined
      assertParamExists('getStudentTranscriptClaims', 'versionId', versionId)
      const localVarPath = `/students/{student_id}/transcripts/{transcript_id}/versions/{version_id}/claims`
        .replace(`{${'student_id'}}`, encodeURIComponent(String(studentId)))
        .replace(`{${'transcript_id'}}`, encodeURIComponent(String(transcriptId)))
        .replace(`{${'version_id'}}`, encodeURIComponent(String(versionId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    /**
     *
     * @summary Get pdf of a specific version of a student transcript.
     * @param {string} studentId
     * @param {string} transcriptId
     * @param {string} versionId
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getStudentTranscriptVersionPdf: async (
      studentId: string,
      transcriptId: string,
      versionId: string,
      options: AxiosRequestConfig = {}
      ...
      // verify required parameter 'studentId' is not null or undefined
      assertParamExists('getStudentTranscriptVersionPdf', 'studentId', studentId)
      // verify required parameter 'transcriptId' is not null or undefined
      assertParamExists('getStudentTranscriptVersionPdf', 'transcriptId', transcriptId)
      // verify required parameter 'versionId' is not null or undefined
      assertParamExists('getStudentTranscriptVersionPdf', 'versionId', versionId)
      const localVarPath = `/students/{student_id}/transcripts/{transcript_id}/versions/{version_id}/raw`
        .replace(`{${'student_id'}}`, encodeURIComponent(String(studentId)))
        .replace(`{${'transcript_id'}}`, encodeURIComponent(String(transcriptId)))
        .replace(`{${'version_id'}}`, encodeURIComponent(String(versionId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    /**
     *
     * @summary Get all transcript of a student
     * @param {string} studentId
     * @param {number} [page]
     * @param {number} [pageSize]
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getStudentTranscripts: async (studentId: string, page?: number, pageSize?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'studentId' is not null or undefined
      assertParamExists('getStudentTranscripts', 'studentId', studentId)
      const localVarPath = `/students/{student_id}/transcripts`.replace(`{${'student_id'}}`, encodeURIComponent(String(studentId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
    ...
    /**
     *
     * @summary Get all versions of a Transcript
     * @param {string} studentId
     * @param {string} transcriptId
     * @param {number} [page]
     * @param {number} [pageSize]
    ...
    getTranscriptsVersions: async (
      ...
      // verify required parameter 'studentId' is not null or undefined
      assertParamExists('getTranscriptsVersions', 'studentId', studentId)
      // verify required parameter 'transcriptId' is not null or undefined
      assertParamExists('getTranscriptsVersions', 'transcriptId', transcriptId)
      const localVarPath = `/students/{student_id}/transcripts/{transcript_id}/versions`
        .replace(`{${'student_id'}}`, encodeURIComponent(String(studentId)))
        .replace(`{${'transcript_id'}}`, encodeURIComponent(String(transcriptId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
    ...
    /**
     *
     * @summary create or modify claim of Transcript Version
     * @param {string} studentId
     * @param {string} transcriptId
     * @param {string} versionId
     * @param {string} claimId
     * @param {StudentTranscriptClaim} studentTranscriptClaim
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    putStudentClaimsOfTranscriptVersion: async (
      studentId: string,
      transcriptId: string,
      versionId: string,
      claimId: string,
      ...
      // verify required parameter 'studentId' is not null or undefined
      assertParamExists('putStudentClaimsOfTranscriptVersion', 'studentId', studentId)
      // verify required parameter 'transcriptId' is not null or undefined
      assertParamExists('putStudentClaimsOfTranscriptVersion', 'transcriptId', transcriptId)
      // verify required parameter 'versionId' is not null or undefined
      assertParamExists('putStudentClaimsOfTranscriptVersion', 'versionId', versionId)
      // verify required parameter 'claimId' is not null or undefined
      assertParamExists('putStudentClaimsOfTranscriptVersion', 'claimId', claimId)
      // verify required parameter 'studentTranscriptClaim' is not null or undefined
      assertParamExists('putStudentClaimsOfTranscriptVersion', 'studentTranscriptClaim', studentTranscriptClaim)
      const localVarPath = `/students/{student_id}/transcripts/{transcript_id}/versions/{version_id}/claims/{claim_id}`
        .replace(`{${'student_id'}}`, encodeURIComponent(String(studentId)))
        .replace(`{${'transcript_id'}}`, encodeURIComponent(String(transcriptId)))
        .replace(`{${'version_id'}}`, encodeURIComponent(String(versionId)))
      ...
      let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {}
      localVarRequestOptions.headers = { ...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers }
      localVarRequestOptions.data = serializeDataIfNeeded(studentTranscriptClaim, localVarRequestOptions, configuration)
    ...
    /**
     *
     * @summary Submit transcript pdf file to latest transcript version
     * @param {string} studentId
     * @param {string} transcriptId
     * @param {File} body
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    putStudentTranscriptVersionPdf: async (studentId: string, transcriptId: string, body: File, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'studentId' is not null or undefined
      assertParamExists('putStudentTranscriptVersionPdf', 'studentId', studentId)
      // verify required parameter 'transcriptId' is not null or undefined
      assertParamExists('putStudentTranscriptVersionPdf', 'transcriptId', transcriptId)
      // verify required parameter 'body' is not null or undefined
      assertParamExists('putStudentTranscriptVersionPdf', 'body', body)
      const localVarPath = `/students/{student_id}/transcripts/{transcript_id}/versions/latest/raw`
        .replace(`{${'student_id'}}`, encodeURIComponent(String(studentId)))
        .replace(`{${'transcript_id'}}`, encodeURIComponent(String(transcriptId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
...
export const TranscriptApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async crudStudentTranscripts(
      studentId: string,
      transcript: Array<Transcript>,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Transcript>>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.crudStudentTranscripts(studentId, transcript, options)
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    async getStudentClaimOfTranscriptVersion(
      studentId: string,
      transcriptId: string,
      versionId: string,
      claimId: string,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<StudentTranscriptClaim>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getStudentClaimOfTranscriptVersion(studentId, transcriptId, versionId, claimId, options)
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    async getStudentTranscriptById(
      studentId: string,
      transcriptId: string,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Transcript>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getStudentTranscriptById(studentId, transcriptId, options)
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    async getStudentTranscriptByVersion(
      studentId: string,
      transcriptId: string,
      versionId: string,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<StudentTranscriptVersion>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getStudentTranscriptByVersion(studentId, transcriptId, versionId, options)
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    async getStudentTranscriptClaims(
      studentId: string,
      transcriptId: string,
      versionId: string,
      page?: number,
      pageSize?: number,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<StudentTranscriptClaim>>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getStudentTranscriptClaims(studentId, transcriptId, versionId, page, pageSize, options)
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    async getStudentTranscriptVersionPdf(
      studentId: string,
      transcriptId: string,
      versionId: string,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<File>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getStudentTranscriptVersionPdf(studentId, transcriptId, versionId, options)
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)
    },
    /**
     *
    ...
    async getStudentTranscripts(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.getStudentTranscripts(studentId, page, pageSize, options)
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    async getTranscriptsVersions(
      studentId: string,
      transcriptId: string,
      page?: number,
      pageSize?: number,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<StudentTranscriptVersion>>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getTranscriptsVersions(studentId, transcriptId, page, pageSize, options)
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    async putStudentClaimsOfTranscriptVersion(
      studentId: string,
      transcriptId: string,
      versionId: string,
      claimId: string,
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.putStudentClaimsOfTranscriptVersion(
        studentId,
        transcriptId,
        versionId,
        claimId,
     ...
     * @throws {RequiredError}
     */
    async putStudentTranscriptVersionPdf(
      studentId: string,
      transcriptId: string,
      body: File,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<StudentTranscriptVersion>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.putStudentTranscriptVersionPdf(studentId, transcriptId, body, options)
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)
    }
  }
}
...
export const TranscriptApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    crudStudentTranscripts(studentId: string, transcript: Array<Transcript>, options?: any): AxiosPromise<Array<Transcript>> {
      return localVarFp.crudStudentTranscripts(studentId, transcript, options).then(request => request(axios, basePath))
    },
    /**
     *
     * @summary Get a claim of transcript version.
     ...
     * @throws {RequiredError}
     */
    getStudentClaimOfTranscriptVersion(
      studentId: string,
      transcriptId: string,
      versionId: string,
      claimId: string,
      options?: any
    ): AxiosPromise<StudentTranscriptClaim> {
      return localVarFp.getStudentClaimOfTranscriptVersion(studentId, transcriptId, versionId, claimId, options).then(request => request(axios, basePath))
    },
    /**
     *
     * @summary Get a student transcript by identifier
     ...
     * @throws {RequiredError}
     */
    getStudentTranscriptById(studentId: string, transcriptId: string, options?: any): AxiosPromise<Transcript> {
      return localVarFp.getStudentTranscriptById(studentId, transcriptId, options).then(request => request(axios, basePath))
    },
    /**
     *
     * @summary Get details of specific version of a student transcript.
     ...
     * @throws {RequiredError}
     */
    getStudentTranscriptByVersion(studentId: string, transcriptId: string, versionId: string, options?: any): AxiosPromise<StudentTranscriptVersion> {
      return localVarFp.getStudentTranscriptByVersion(studentId, transcriptId, versionId, options).then(request => request(axios, basePath))
    },
    /**
     *
     * @summary Get all claims for a specific version of a student transcript.
    ...
    getStudentTranscriptClaims(
      ...
      pageSize?: number,
      options?: any
    ): AxiosPromise<Array<StudentTranscriptClaim>> {
      return localVarFp.getStudentTranscriptClaims(studentId, transcriptId, versionId, page, pageSize, options).then(request => request(axios, basePath))
    },
    /**
     *
     * @summary Get pdf of a specific version of a student transcript.
     ...
     * @throws {RequiredError}
     */
    getStudentTranscriptVersionPdf(studentId: string, transcriptId: string, versionId: string, options?: any): AxiosPromise<File> {
      return localVarFp.getStudentTranscriptVersionPdf(studentId, transcriptId, versionId, options).then(request => request(axios, basePath))
    },
    /**
     *
     * @summary Get all transcript of a student
     ...
     * @throws {RequiredError}
     */
    getStudentTranscripts(studentId: string, page?: number, pageSize?: number, options?: any): AxiosPromise<Array<Transcript>> {
      return localVarFp.getStudentTranscripts(studentId, page, pageSize, options).then(request => request(axios, basePath))
    },
    /**
     *
     * @summary Get all versions of a Transcript
    ...
    getTranscriptsVersions(
      ...
      pageSize?: number,
      options?: any
    ): AxiosPromise<Array<StudentTranscriptVersion>> {
      return localVarFp.getTranscriptsVersions(studentId, transcriptId, page, pageSize, options).then(request => request(axios, basePath))
    },
    /**
     *
     * @summary create or modify claim of Transcript Version
     ...
     * @throws {RequiredError}
     */
    putStudentClaimsOfTranscriptVersion(
      studentId: string,
      transcriptId: string,
      versionId: string,
      claimId: string,
      ...
      return localVarFp
        .putStudentClaimsOfTranscriptVersion(studentId, transcriptId, versionId, claimId, studentTranscriptClaim, options)
        .then(request => request(axios, basePath))
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    putStudentTranscriptVersionPdf(studentId: string, transcriptId: string, body: File, options?: any): AxiosPromise<StudentTranscriptVersion> {
      return localVarFp.putStudentTranscriptVersionPdf(studentId, transcriptId, body, options).then(request => request(axios, basePath))
    }
  }
}
...
export class TranscriptApi extends BaseAPI {
   ...
   */
  public crudStudentTranscripts(studentId: string, transcript: Array<Transcript>, options?: AxiosRequestConfig) {
    return TranscriptApiFp(this.configuration)
      .crudStudentTranscripts(studentId, transcript, options)
      .then(request => request(this.axios, this.basePath))
  }
   ...
   * @memberof TranscriptApi
   */
  public getStudentClaimOfTranscriptVersion(studentId: string, transcriptId: string, versionId: string, claimId: string, options?: AxiosRequestConfig) {
    return TranscriptApiFp(this.configuration)
      .getStudentClaimOfTranscriptVersion(studentId, transcriptId, versionId, claimId, options)
      .then(request => request(this.axios, this.basePath))
  }
   ...
   * @memberof TranscriptApi
   */
  public getStudentTranscriptById(studentId: string, transcriptId: string, options?: AxiosRequestConfig) {
    return TranscriptApiFp(this.configuration)
      .getStudentTranscriptById(studentId, transcriptId, options)
      .then(request => request(this.axios, this.basePath))
  }
   ...
   * @memberof TranscriptApi
   */
  public getStudentTranscriptByVersion(studentId: string, transcriptId: string, versionId: string, options?: AxiosRequestConfig) {
    return TranscriptApiFp(this.configuration)
      .getStudentTranscriptByVersion(studentId, transcriptId, versionId, options)
      .then(request => request(this.axios, this.basePath))
  }
   ...
   * @memberof TranscriptApi
   */
  public getStudentTranscriptClaims(
    studentId: string,
    transcriptId: string,
    versionId: string,
    page?: number,
    ...
    return TranscriptApiFp(this.configuration)
      .getStudentTranscriptClaims(studentId, transcriptId, versionId, page, pageSize, options)
      .then(request => request(this.axios, this.basePath))
  }
   ...
   * @memberof TranscriptApi
   */
  public getStudentTranscriptVersionPdf(studentId: string, transcriptId: string, versionId: string, options?: AxiosRequestConfig) {
    return TranscriptApiFp(this.configuration)
      .getStudentTranscriptVersionPdf(studentId, transcriptId, versionId, options)
      .then(request => request(this.axios, this.basePath))
  }
   ...
   * @memberof TranscriptApi
   */
  public getStudentTranscripts(studentId: string, page?: number, pageSize?: number, options?: AxiosRequestConfig) {
    return TranscriptApiFp(this.configuration)
      .getStudentTranscripts(studentId, page, pageSize, options)
      .then(request => request(this.axios, this.basePath))
  }
   ...
   * @memberof TranscriptApi
   */
  public getTranscriptsVersions(studentId: string, transcriptId: string, page?: number, pageSize?: number, options?: AxiosRequestConfig) {
    return TranscriptApiFp(this.configuration)
      .getTranscriptsVersions(studentId, transcriptId, page, pageSize, options)
      .then(request => request(this.axios, this.basePath))
  }
   ...
   * @memberof TranscriptApi
   */
  public putStudentClaimsOfTranscriptVersion(
    studentId: string,
    transcriptId: string,
    versionId: string,
    claimId: string,
   ...
   * @memberof TranscriptApi
   */
  public putStudentTranscriptVersionPdf(studentId: string, transcriptId: string, body: File, options?: AxiosRequestConfig) {
    return TranscriptApiFp(this.configuration)
      .putStudentTranscriptVersionPdf(studentId, transcriptId, body, options)
      .then(request => request(this.axios, this.basePath))
  }
}
